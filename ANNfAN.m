...
%      singleton*.
%
%      H = ANNfAN returns the handle to a new ANNfAN or the handle to
%      the existing singleton*.
%
%      ANNfAN('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ANNfAN.M with the given input arguments.
%
%      ANNfAN('Property','Value',...) creates a new ANNfAN or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the ANNfAN before ANNfAN_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ANNfAN_OpeningFcn via varargin.
%
%      *See ANNfAN Options on GUIDE's Tools menu.  Choose "ANNfAN allows only one
%      instance to run (singleton)".
%
% See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help ANNfAN

% Last Modified by GUIDE v2.5 07-Sep-2020 22:30:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ANNfAN_OpeningFcn, ...
                   'gui_OutputFcn',  @ANNfAN_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ANNfAN is made visible.
function ANNfAN_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ANNfAN (see VARARGIN)

% Choose default command line output for ANNfAN
...
% UIWAIT makes ANNfAN wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ANNfAN_OutputFcn(hObject, eventdata, handles) 
